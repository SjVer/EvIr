...
\DoxyCodeLine{85 \textcolor{preprocessor}{    private: membertype membername; \(\backslash\)}}
\DoxyCodeLine{86 \textcolor{preprocessor}{    public: name(membertype membername): membername(membername) \{\}; \}}}
\DoxyCodeLine{87 }
\DoxyCodeLine{88 SIMPLE\_CONSTANT(\mbox{\hyperlink{classevir_1_1IntegerConst}{IntegerConst}},   CONSTANT\_INTEGER,   int64, value);}
\DoxyCodeLine{89 SIMPLE\_CONSTANT(\mbox{\hyperlink{classevir_1_1FloatConst}{FloatConst}},   CONSTANT\_FLOAT,     float2, value);}
\DoxyCodeLine{90 }
\DoxyCodeLine{91 SIMPLE\_CONSTANT(\mbox{\hyperlink{classevir_1_1ArrayConst}{ArrayConst}},   CONSTANT\_ARRAY,     Vector<Value*>, elements);}
\DoxyCodeLine{92 SIMPLE\_CONSTANT(\mbox{\hyperlink{classevir_1_1MapConst}{MapConst}},       CONSTANT\_MAP,       Map<Value* COMMA Value*>, pairs);}
\DoxyCodeLine{93 }
\DoxyCodeLine{94 \textcolor{keyword}{class }\mbox{\hyperlink{classevir_1_1StringConst}{StringConst}} : \textcolor{keyword}{public} \mbox{\hyperlink{classevir_1_1ArrayConst}{ArrayConst}}}
\DoxyCodeLine{95 \{}
\DoxyCodeLine{96     String string;}
\DoxyCodeLine{97 }
\DoxyCodeLine{98 \textcolor{keyword}{public}:}
\DoxyCodeLine{99     \mbox{\hyperlink{classevir_1_1StringConst}{StringConst}}(String \textcolor{keywordtype}{string});}
\DoxyCodeLine{100 }
\DoxyCodeLine{102     String \mbox{\hyperlink{classevir_1_1StringConst_a30688b68108d552ec4237638b64264ad}{generate\_ir}}();}
\DoxyCodeLine{103 \};}
\DoxyCodeLine{104 }
...
\DoxyCodeLine{109 \}}
\DoxyCodeLine{110 }
\DoxyCodeLine{111 \textcolor{preprocessor}{\#endif }\textcolor{comment}{// EVIR\_IR\_VALUE\_CONSTANT\_H}}
